...
////
////// uses desubscriber<> (void handler returns, requires key arg).
////struct mock_desubscriber
////{
////    static constexpr std::tuple methods
////    {
////        method<"ping", messages::peer::ping::cptr, key_type>{ "message", "key" },
////    };
////
////    template <typename... Args>
////    using subscriber = network::desubscriber<key_type, Args...>;
////
...
////using mock_broadcaster = dispatcher<mock_desubscriber_interface>;
////static_assert(is_same_type<mock_desubscriber_interface::key, key_type>);
