...
////}
////
////BOOST_AUTO_TEST_CASE(broadcaster__notify__invalid_message__no_notification)
////{
////    threadpool pool(2);
////    asio::strand strand(pool.service().get_executor());
////    broadcaster instance(strand);
...
////}
////
////BOOST_AUTO_TEST_CASE(broadcaster__notify__valid_message_invalid_version__no_notification)
////{
////    threadpool pool(2);
////    asio::strand strand(pool.service().get_executor());
////    broadcaster instance(strand);
