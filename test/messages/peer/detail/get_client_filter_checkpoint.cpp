...
BOOST_AUTO_TEST_SUITE(p2p_get_client_filter_checkpoint_tests)
...
BOOST_AUTO_TEST_CASE(get_client_filter_checkpoint__properties__always__expected)
{
    ...
    constexpr auto index = messages::peer::registry::index_of<get_client_filter_checkpoint>();
    BOOST_REQUIRE_EQUAL(messages::peer::registry::commands().at(index), get_client_filter_checkpoint::command);
