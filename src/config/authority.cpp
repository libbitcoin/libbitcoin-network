...
messages::peer::address_item authority::to_address_item() const NOEXCEPT
{
    return to_address_item({}, messages::peer::service::node_none);
}
...
bool authority::operator==(const messages::peer::address_item& other) const NOEXCEPT
{
