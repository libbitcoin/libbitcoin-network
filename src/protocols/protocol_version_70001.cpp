...
////}
////
////const std::string& protocol_version_70001::name() const
////{
...
////// ----------------------------------------------------------------------------
////
////version protocol_version_70001::version_factory() const
////{
...
////// ----------------------------------------------------------------------------
////
////void protocol_version_70001::start(result_handler&& handle_event)
////{
...
////// ----------------------------------------------------------------------------
////
////bool protocol_version_70001::sufficient_peer(const version::ptr& message)
////{
////    BC_ASSERT_MSG(stranded(), "stranded");
////
...
////}
////
////void protocol_version_70001::handle_receive_reject(const code& ec,
