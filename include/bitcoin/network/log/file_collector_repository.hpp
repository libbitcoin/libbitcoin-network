...
#ifndef LIBBITCOIN_NETWORK_LOG_FILE_COLLECTOR_REPOSITORY_HPP
#define LIBBITCOIN_NETWORK_LOG_FILE_COLLECTOR_REPOSITORY_HPP
...
class BCT_API file_collector_repository :
...
BCT_API boost::shared_ptr<boost::log::sinks::file::collector> make_collector(
