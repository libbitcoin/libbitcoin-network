 ...
 */
#ifndef LIBBITCOIN_NETWORK_MESSAGES_P2P_ADDRESS_ITEM_HPP
#define LIBBITCOIN_NETWORK_MESSAGES_P2P_ADDRESS_ITEM_HPP
...
using address_item_cptr = messages::p2p::address_item::cptr;
...
{
template<>
struct hash<bc::network::messages::p2p::address_item>
{
    size_t operator()(
        const bc::network::messages::p2p::address_item& value) const NOEXCEPT
    {
        return bc::system::hash_combine(
            std::hash<bc::network::messages::p2p::ip_address>{}(value.ip),
