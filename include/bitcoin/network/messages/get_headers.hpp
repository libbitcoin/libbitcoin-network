 ...
 */
#ifndef LIBBITCOIN_NETWORK_MESSAGES_GET_HEADERS_HPP
#define LIBBITCOIN_NETWORK_MESSAGES_GET_HEADERS_HPP
  ...
  : public get_blocks
{
    ...
    static get_headers deserialize(uint32_t version, system::reader& source);
