 ...
 */
#ifndef LIBBITCOIN_NETWORK_MESSAGES_PEER_HEADING_HPP
...
struct BCT_API heading
{
    ...
    static constexpr size_t maximum_payload(bool witness) NOEXCEPT
    {
        ...
        return witness ? max_payload : non_witness;
    }
