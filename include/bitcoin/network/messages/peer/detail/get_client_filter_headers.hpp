...
#ifndef LIBBITCOIN_NETWORK_MESSAGES_PEER_GET_CLIENT_FILTER_HEADERS_HPP
#define LIBBITCOIN_NETWORK_MESSAGES_PEER_GET_CLIENT_FILTER_HEADERS_HPP
...
struct BCT_API get_client_filter_headers
{
    ...
    static constexpr uint8_t identifier{ identifiers::get_client_filter_headers };
