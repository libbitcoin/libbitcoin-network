 ...
 */
#ifndef LIBBITCOIN_NETWORK_MESSAGES_PEER_ADDRESS_HPP
#define LIBBITCOIN_NETWORK_MESSAGES_PEER_ADDRESS_HPP
...
struct BCT_API address
{
    ...
    static constexpr uint8_t identifier{ identifiers::address };
...
using address_cptr = messages::peer::address::cptr;
