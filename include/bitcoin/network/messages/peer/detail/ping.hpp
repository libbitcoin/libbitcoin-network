 ...
 */
#ifndef LIBBITCOIN_NETWORK_MESSAGES_PEER_PING_HPP
#define LIBBITCOIN_NETWORK_MESSAGES_PEER_PING_HPP
...
struct BCT_API ping
{
    ...
    static constexpr uint8_t identifier{ identifiers::ping };
    ...
    static ping deserialize(uint32_t version,
