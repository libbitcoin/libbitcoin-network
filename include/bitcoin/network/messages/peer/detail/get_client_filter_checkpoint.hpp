...
#ifndef LIBBITCOIN_NETWORK_MESSAGES_PEER_GET_CLIENT_FILTER_CHECKPOINT_HPP
#define LIBBITCOIN_NETWORK_MESSAGES_PEER_GET_CLIENT_FILTER_CHECKPOINT_HPP
...
{
    typedef std::shared_ptr<const get_client_filter_checkpoint> cptr;

    static constexpr uint8_t identifier{ identifiers::get_client_filter_checkpoint };
