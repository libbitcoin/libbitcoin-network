 ...
 */
#ifndef LIBBITCOIN_NETWORK_MESSAGES_PEER_FEE_FILTER_HPP
#define LIBBITCOIN_NETWORK_MESSAGES_PEER_FEE_FILTER_HPP
...
struct BCT_API fee_filter
{
    ...
    static constexpr uint8_t identifier{ identifiers::fee_filter };
