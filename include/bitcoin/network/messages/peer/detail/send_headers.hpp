 ...
 */
#ifndef LIBBITCOIN_NETWORK_MESSAGES_PEER_SEND_HEADERS_HPP
#define LIBBITCOIN_NETWORK_MESSAGES_PEER_SEND_HEADERS_HPP
...
struct BCT_API send_headers
{
    ...
    static send_headers deserialize(uint32_t version,
