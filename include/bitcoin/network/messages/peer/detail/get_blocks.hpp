 ...
 */
#ifndef LIBBITCOIN_NETWORK_MESSAGES_PEER_GET_BLOCKS_HPP
#define LIBBITCOIN_NETWORK_MESSAGES_PEER_GET_BLOCKS_HPP
...
struct BCT_API get_blocks
{
    ...
    static constexpr uint8_t identifier{ identifiers::get_blocks };
