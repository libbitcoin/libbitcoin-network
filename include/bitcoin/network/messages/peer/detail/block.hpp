 ...
 */
#ifndef LIBBITCOIN_NETWORK_MESSAGES_PEER_BLOCK_HPP
#define LIBBITCOIN_NETWORK_MESSAGES_PEER_BLOCK_HPP
...
struct BCT_API block
{
    ...
    static constexpr uint8_t identifier{ identifiers::block };
