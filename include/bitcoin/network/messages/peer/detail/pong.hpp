 ...
 */
#ifndef LIBBITCOIN_NETWORK_MESSAGES_PEER_PONG_HPP
#define LIBBITCOIN_NETWORK_MESSAGES_PEER_PONG_HPP
...
struct BCT_API pong
{
    ...
    static constexpr uint8_t identifier{ identifiers::pong };
    ...
    static pong deserialize(uint32_t version,
