 ...
 */
#ifndef LIBBITCOIN_NETWORK_MESSAGES_PEER_MERKLE_BLOCK_HPP
#define LIBBITCOIN_NETWORK_MESSAGES_PEER_MERKLE_BLOCK_HPP
...
public:
    ...
    static constexpr uint8_t identifier{ identifiers::merkle_block };
