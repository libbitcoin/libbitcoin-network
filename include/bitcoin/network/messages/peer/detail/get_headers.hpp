 ...
 */
#ifndef LIBBITCOIN_NETWORK_MESSAGES_PEER_GET_HEADERS_HPP
#define LIBBITCOIN_NETWORK_MESSAGES_PEER_GET_HEADERS_HPP
...
struct BCT_API get_headers
{
    ...
    static constexpr uint8_t identifier{ identifiers::get_headers };
