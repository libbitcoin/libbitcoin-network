...
#
###############################################################################
# Script managing the build and installation of libbitcoin-network and its dependencies.
#
# Script options:
...
main()
{
    ...
    if ! [[ "${BUILD_SKIP_TESTS}" == "yes" ]]; then
        test_gnu "libbitcoin-network" "builds/gnu" "${PARALLEL}"
    fi
...
help()
{
    msg "Script managing the build and installation of libbitcoin-network and its dependencies."
    msg ""
    msg "Script options:"
